...
// Defining the APatientTable functional component
  ...
  return (
    <div>
      <table className="w-full table-auto">
        ...
        <tbody>
          {/* Mapping through the data to render each child's information */}
          {data.map((item, index) => (
            <tr
              key={item._id}
            ...
            >
              ...
              <td className={tdclass}>
                {/* Link to view the child's details */}
                <Link
                  to={`/A.patients/preview/${item._id}`}
