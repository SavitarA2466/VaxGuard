  ...
  return (
    <Layout>
      <div className="flex items-center gap-4">
        ...
        <h1 className="text-xl font-semibold">Elina</h1>
      </div>
      <div className=" grid grid-cols-12 gap-6 my-8 items-start">
        ...
        >
          <div className="gap-2 flex-colo">
            <h2 className="text-sm font-semibold">Elina</h2>
            <p className="text-xs text-textGray">ravi@gmail.com</p>
            <p className="text-xs">0766806066</p>
          </div>
          {/* tabs */}
