...
import { announcementData } from '../Components/Datas';
import { TbBrandWhatsapp, TbMessage } from 'react-icons/tb';
import DAnnouncementModal from '../Components/Modals/D.AddAnnouncementModal';
...
function DAnnouncement() {
  ...
  return (
    <Layout>
      {isOpen && (
        <DAnnouncementModal isOpen={isOpen} closeModal={closeModal} data={data} />
      )}
